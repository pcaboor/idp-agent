...
<p align="center">
  ...
  <img alt="Tests: 1733, no API key" src="https://img.shields.io/badge/tests-1733%20%C2%B7%20no%20API%20key-success.svg">
...
- 🧪 **Reproducible without an API key.** 1733 tests run offline from recordings: no
