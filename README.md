...
<p align="center">
  ...
  <img alt="Tests: 1822, no API key" src="https://img.shields.io/badge/tests-1822%20%C2%B7%20no%20API%20key-success.svg">
...
- 🧪 **Reproducible without an API key.** 1822 tests run offline from recordings: no
