...
<p align="center">
  ...
  <img alt="Tests: 1818, no API key" src="https://img.shields.io/badge/tests-1818%20%C2%B7%20no%20API%20key-success.svg">
...
- 🧪 **Reproducible without an API key.** 1818 tests run offline from recordings: no
