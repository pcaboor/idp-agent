...
<p align="center">
  ...
  <img alt="Tests: 1401, no API key" src="https://img.shields.io/badge/tests-1401%20%C2%B7%20no%20API%20key-success.svg">
...
- 🧪 **Reproducible without an API key.** 1401 tests run offline from recordings: no
